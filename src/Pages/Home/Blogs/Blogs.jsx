...
const Blogs = () => {
    return (
        <div className=' w-[95%] lg:w-[100%] grid lg:grid-cols-2 gap-6 rounded bg-[#52fff3] mt-10 mb-6 p-4 py-10 lg:px-20 lg:py-16 mx-auto'>
            <div className='rounded bg-black text-white px-8 py-5'>
