                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" placeholder="Photo URL" name="name" className="input w-full  input-info max-w-xs" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <input type="password" placeholder="Password" className="input w-full  input-info max-w-xs" />
                        </div>
